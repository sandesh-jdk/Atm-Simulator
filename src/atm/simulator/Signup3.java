...
public class Signup3 extends JFrame implements ActionListener{
      ...
      type.setFont(new Font("Raleway",Font.BOLD,22));
        ...
        add(card);
         ...
         JLabel  number = new JLabel("XXXX-XXXX-XXXX-7557");
        ...
        add(c6);
         ...
         c7=new JCheckBox("Hereby decalres that the above details are correct to the best of my knowledge");
